...
<body>
    ...
    <form action="/php/trade/setting.php" method="post">
        <div>
    ...
    <h2>PDF</h2>
    <form enctype="multipart/form-data" action="/php/trade/save_file.php" method="POST">
    ...
    <?php
        ...
        foreach ($filenames as $filename) {
            echo "<li><a href=\"/php/trade/download_file.php?name={$filename}\" target=\"_blank\">{$filename}</a></li>";
        }
        echo "</ul>";
    ?>
    
    <h2><?php echo $dictionary->ADMINISTRATORS ?></h2>
    <form action="/php/trade/add_user.php" method="post">
    ...
    foreach ($result as $row) {
        ...
        echo "<a href=\"/php/trade/delete_user.php?ID={$row['ID']}\">";
        echo "X";
        echo "</a>";
    ...
    <form action="/php/trade/add_order.php" method="post">
    ...
    foreach ($result as $row) {
        ...
        if($row['status'] != "Отменен") {
            ...
            echo "<a href=\"/php/trade/cancel_order.php?ID={$row['ID']}\">";
